package com.txt.video.ui.weight.danmu.adapter
...
import com.txt.video.ui.weight.danmu.entity.BULLET_TYPE_NOTICE
...
class BulletAdapter : RecyclerView.Adapter<BulletAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.tx_item_bullet, parent, false)
