package com.txt.video.ui.weight.danmu.dialog
...
class InputDialog : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NO_FRAME, R.style.tx_InputDialog)
    ...
    override fun onCreateView(
        ...
        restoreWindow()
        return inflater.inflate(R.layout.tx_fragment_input_dialog, container)
    }
