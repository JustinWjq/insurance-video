...
public class TRTCCloudManager {
    ...
    private static volatile TRTCCloudManager instance;
    public static TRTCCloudManager sharedInstance() {
        if (instance == null) {
            synchronized (SYNC) {
                if (instance == null) {
                    instance = new TRTCCloudManager();
                }
            }
        }
        return instance;
     ...
     */
    public void init(Context context, TRTCCloud trtcCloud, TRTCCloudDef.TRTCParams trtcParams, int appScene){
        mContext = context;
