...
/**
 * 用于管理单(横竖屏)行的recyclerview
 */
public class MeetingPageLayoutManager1 extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     */
    public MeetingPageLayoutManager1(@IntRange(from = 1, to = 100) int rows,
