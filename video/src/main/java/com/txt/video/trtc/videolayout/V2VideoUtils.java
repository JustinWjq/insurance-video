...
public class V2VideoUtils {
    ...
    public static ArrayList<RelativeLayout.LayoutParams> initFloatParamList(Context context, int layoutWidth, int layoutHeight) {
        ...
        final int midMargin = V2VideoUtils.dip2px(context, 10);
        final int lrMargin = V2VideoUtils.dip2px(context, 15);
        final int bottomMargin = V2VideoUtils.dip2px(context, 50);
//        final int subWidth = Utils.dip2px(context, 100);
        final int subHeight = V2VideoUtils.dip2px(context, 140);
...
//        }
     ...
     * @return
     */
    public static ArrayList<RelativeLayout.LayoutParams> initGridOneParam(Context context, int layoutWidth, int layoutHeight) {
        int margin = dip2px(context, 10);
        int bottomMargin = dip2px(context, 50);

        ArrayList<RelativeLayout.LayoutParams> list = new ArrayList<>();
        int grid4W = (layoutWidth - margin * 2) ;
        int grid4H = (layoutHeight - margin * 2 );
    ...
    public static ArrayList<RelativeLayout.LayoutParams> initGrid3Param(Context context, int layoutWidth, int layoutHeight) {
        ...
        RelativeLayout.LayoutParams layoutParams0 = new RelativeLayout.LayoutParams(grid4W, grid4H*2);
        layoutParams0.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
        layoutParams0.addRule(RelativeLayout.ALIGN_PARENT_TOP);
        layoutParams0.topMargin = margin;
        layoutParams0.leftMargin = margin;
