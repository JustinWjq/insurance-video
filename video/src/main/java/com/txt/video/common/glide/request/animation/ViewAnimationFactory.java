...
/**
 * A {@link com.txt.video.common.glide.request.animation.GlideAnimationFactory} that produces
 * {@link com.txt.video.common.glide.request.animation.ViewAnimation}s.
 *
...
public class ViewAnimationFactory<R> implements GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link com.txt.video.common.glide.request.animation.GlideAnimation} for the given arguments. If
     * isFromMemoryCache is {@code true} or isFirstImage is {@code false}, returns a
     * {@link com.txt.video.common.glide.request.animation.NoAnimation} and otherwise returns a new
