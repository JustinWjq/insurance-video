package com.txt.video.common.glide.request;
...
import com.txt.video.common.glide.util.LogTime;
import com.txt.video.common.glide.util.Util;

import java.util.Queue;

/**
 * A {@link Request} that loads a {@link com.txt.video.common.glide.load.engine.Resource} into a given {@link Target}.
 *
...
public final class GenericRequest<A, T, Z, R> implements Request, SizeReadyCallback,
    ...
    public static <A, T, Z, R> com.txt.video.common.glide.request.GenericRequest<A, T, Z, R> obtain(
        ...
        com.txt.video.common.glide.request.GenericRequest<A, T, Z, R> request = (com.txt.video.common.glide.request.GenericRequest<A, T, Z, R>) REQUEST_POOL.poll();
        if (request == null) {
            request = new com.txt.video.common.glide.request.GenericRequest<A, T, Z, R>();
        }
