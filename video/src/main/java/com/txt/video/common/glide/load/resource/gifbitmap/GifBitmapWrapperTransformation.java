...
/**
 * A {@link com.txt.video.common.glide.load.Transformation} that can apply a wrapped {@link Bitmap}
 * transformation to both {@link Bitmap}s and {@link com.txt.video.common.glide.load.resource.gif.GifDrawable}.
 */
