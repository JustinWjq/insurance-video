...
import com.txt.video.common.glide.load.model.ImageVideoModelLoader;
 ...
 * adds an {@link com.txt.video.common.glide.load.resource.transcode.ResourceTranscoder} to transcode the data into a
 ...
 */
public class DrawableTypeRequest<ModelType> extends DrawableRequestBuilder<ModelType> implements com.txt.video.common.glide.DownloadOptions {
    ...
    /**
     * Attempts to always load the resource as a {@link com.txt.video.common.glide.load.resource.gif.GifDrawable}.
     * <p>
     ...
     *     just an {@link com.txt.video.common.glide.DrawableTypeRequest} is sufficient because it will determine whether or
     ...
     * </p>
     *
     * @return A new request builder for loading a {@link com.txt.video.common.glide.load.resource.gif.GifDrawable}.
     */
