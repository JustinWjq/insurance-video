 ...
 * returned by a {@link com.txt.video.common.glide.load.resource.bitmap.BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@link com.txt.video.common.glide.load.resource.bitmap.BitmapDecoder}s support setting formats and certain images may
...
public enum DecodeFormat {
    /**
     * All bitmaps returned by the {@link com.txt.video.common.glide.load.resource.bitmap.BitmapDecoder} should return
