...
public class ExceptionCatchingInputStream extends InputStream {
    ...
    public static com.txt.video.common.glide.util.ExceptionCatchingInputStream obtain(InputStream toWrap) {
        com.txt.video.common.glide.util.ExceptionCatchingInputStream result;
        synchronized (QUEUE) {
            result = QUEUE.poll();
        }
        if (result == null) {
            result = new com.txt.video.common.glide.util.ExceptionCatchingInputStream();
        }
