...
import com.txt.video.common.glide.load.resource.bitmap.Downsampler;
import com.txt.video.common.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.txt.video.common.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.txt.video.common.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.txt.video.common.glide.load.resource.bitmap.VideoBitmapDecoder;
...
import com.txt.video.common.glide.request.animation.BitmapCrossFadeFactory;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
        ...
        implements com.txt.video.common.glide.BitmapOptions, com.txt.video.common.glide.DrawableOptions {
     ...
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> approximate() {
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> asIs() {
        return downsample(Downsampler.NONE);
    }

    /**
     * Load images at a size that is at most exactly as big as the target using
     * {@link com.txt.video.common.glide.load.resource.bitmap.Downsampler#AT_MOST}.
     *
     * @see #downsample(com.txt.video.common.glide.load.resource.bitmap.Downsampler)
     *
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> atMost() {
     ...
     * @return This request builder.
     */
    private com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> downsample(Downsampler downsampler) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(float sizeMultiplier) {
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(com.txt.video.common.glide.BitmapRequestBuilder<?, TranscodeType>
            thumbnailRequest) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> sizeMultiplier(float sizeMultiplier) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> decoder(ResourceDecoder<ImageVideoWrapper, Bitmap> decoder) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> cacheDecoder(ResourceDecoder<File, Bitmap> cacheDecoder) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> encoder(ResourceEncoder<Bitmap> encoder) {
        super.encoder(encoder);
        return this;
    }

    /**
     * Sets the {@link com.txt.video.common.glide.load.ResourceDecoder} that will be used to decode {@link Bitmap}s obtained
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> imageDecoder(ResourceDecoder<InputStream, Bitmap> decoder) {
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> videoDecoder(
     ...
     * {@link #cacheDecoder(com.txt.video.common.glide.load.ResourceDecoder)}} with default decoders with the appropriate
     * options set.
     *
     * <p>
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> format(DecodeFormat format) {
    ...
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> priority(Priority priority) {
        super.priority(priority);
        return this;
    }

    /**
     * Transform images using the given {@link com.txt.video.common.glide.load.resource.bitmap.BitmapTransformation}s.
     *
     * @see #centerCrop()
     * @see #fitCenter()
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> transform(BitmapTransformation... transformations) {
        super.transform(transformations);
        return this;
    }

    /**
     * Transform images using {@link com.txt.video.common.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transform(com.txt.video.common.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.txt.video.common.glide.load.Transformation[])
     *
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> centerCrop() {
        return transform(glide.getBitmapCenterCrop());
    }

    /**
     * Transform images using {@link com.txt.video.common.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(com.txt.video.common.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(com.txt.video.common.glide.load.Transformation[])
     ...
     * @return This request builder.
     */
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> fitCenter() {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> transform(Transformation<Bitmap>... transformations) {
        super.transform(transformations);
        return this;
    }
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> transcoder(
    ...
    public final com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade() {
     ...
     */
    @SuppressWarnings("unchecked")
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade(int duration) {
        if (Bitmap.class.isAssignableFrom(transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>)
    ...
    @Deprecated
    @SuppressWarnings("unchecked")
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade(Animation animation, int duration) {
        if (Bitmap.class.isAssignableFrom(transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>)
     ...
     */
    @SuppressWarnings("unchecked")
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> crossFade(int animationId, int duration) {
        if (Bitmap.class.isAssignableFrom(transcodeClass)) {
            return animate((GlideAnimationFactory<TranscodeType>)
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> dontAnimate() {
        super.dontAnimate();
        return this;
    }
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(int animationId) {
    ...
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(Animation animation) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(ViewPropertyAnimation.Animator animator) {
    ...
    /**
     * {@inheritDoc}
     * @see com.txt.video.common.glide.request.animation.BitmapContainerCrossFadeFactory
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> animate(
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> placeholder(int resourceId) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> placeholder(Drawable drawable) {
        super.placeholder(drawable);
        return this;
    }

    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> fallback(Drawable drawable) {
        super.fallback(drawable);
        return this;
    }

    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> fallback(int resourceId) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> error(int resourceId) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> error(Drawable drawable) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> listener(
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> skipMemoryCache(boolean skip) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> diskCacheStrategy(DiskCacheStrategy strategy) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> override(int width, int height) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> thumbnail(
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> sourceEncoder(Encoder<ImageVideoWrapper> sourceEncoder) {
     ...
     */
    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> dontTransform() {
        super.dontTransform();
        return this;
    }

    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> signature(Key signature) {
        super.signature(signature);
        return this;
    }

    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> load(ModelType model) {
        super.load(model);
        return this;
    }

    @Override
    public com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType> clone() {
        return (com.txt.video.common.glide.BitmapRequestBuilder<ModelType, TranscodeType>) super.clone();
    }
