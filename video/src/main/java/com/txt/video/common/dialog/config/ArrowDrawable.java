...
import com.txt.video.common.dialog.config.gravity.HorizontalGravity;
import com.txt.video.common.dialog.config.gravity.VerticalGravity;
...
public class ArrowDrawable extends Drawable {
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.tx_ArrowDrawable);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.tx_ArrowDrawable_tx_ad_bgColor) {
            mBgColor = typedArray.getColor(attr, mBgColor);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_shadowColor) {
            mShadowColor = typedArray.getColor(attr, mShadowColor);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_arrowHeight) {
            mArrowHeight = typedArray.getDimensionPixelSize(attr, mArrowHeight);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_shadowSize) {
            mShadowSize = typedArray.getDimensionPixelSize(attr, mShadowSize);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_radius) {
            mRadius = typedArray.getDimensionPixelSize(attr, mRadius);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_arrowExtraOffsetX) {
            mArrowOffsetX = typedArray.getDimensionPixelSize(attr, mArrowOffsetX);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_arrowExtraOffsetY) {
            mArrowOffsetY = typedArray.getDimensionPixelSize(attr, mArrowOffsetY);
        } else if (attr == R.styleable.tx_ArrowDrawable_tx_ad_arrowGravity) {
