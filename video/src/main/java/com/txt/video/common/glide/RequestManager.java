...
import com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import com.txt.video.common.glide.load.model.stream.MediaStoreStreamLoader;
import com.txt.video.common.glide.load.model.stream.StreamByteArrayLoader;
import com.txt.video.common.glide.load.model.stream.StreamModelLoader;
import com.txt.video.common.glide.manager.ConnectivityMonitor;
import com.txt.video.common.glide.manager.ConnectivityMonitorFactory;
import com.txt.video.common.glide.manager.Lifecycle;
import com.txt.video.common.glide.manager.LifecycleListener;
import com.txt.video.common.glide.manager.RequestManagerTreeNode;
import com.txt.video.common.glide.manager.RequestTracker;
import com.txt.video.common.glide.signature.ApplicationVersionSignature;
import com.txt.video.common.glide.signature.MediaStoreSignature;
import com.txt.video.common.glide.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
    ...
    RequestManager(Context context, final Lifecycle lifecycle, RequestManagerTreeNode treeNode,
        ...
        if (Util.isOnBackgroundThread()) {
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                @Override
                public void run() {
                    lifecycle.addListener(com.txt.video.common.glide.RequestManager.this);
                }
            });
        } else {
     ...
     * {@link com.txt.video.common.glide.RequestManager}.
     */
    ...
    /**
     * Sets an interface that can apply some default options to all Requests started using this {@link com.txt.video.common.glide.RequestManager}.
     *
     * <p>
     *     Note - These options will be retained for the life the of this {@link com.txt.video.common.glide.RequestManager}
     *     so be wary of using
     *     {@link com.txt.video.common.glide.GenericRequestBuilder#listener(com.txt.video.common.glide.request.RequestListener)}} when
    ...
    /**
     * Returns true if loads for this {@link com.txt.video.common.glide.RequestManager} are currently paused.
     *
     * @see #pauseRequests()
     * @see #resumeRequests()
     */
    ...
    public void pauseRequestsRecursive() {
        Util.assertMainThread();
        pauseRequests();
        for (com.txt.video.common.glide.RequestManager requestManager : treeNode.getDescendants()) {
    ...
    /**
     * Returns a request builder that uses the given {@link com.txt.video.common.glide.load.model.ModelLoader} to fetch a
     * generic data type.
     *
     * <p>
    ...
    /**
     * Returns a request builder that uses the given {@link com.txt.video.common.glide.load.model.stream.StreamModelLoader} to
     ...
     * {@link com.txt.video.common.glide.load.model.stream.StreamByteArrayLoader} to fetch an {@link InputStream} for
     * loading Bitmaps.
     *
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link com.txt.video.common.glide.load.model.UriLoader}.
     */
     ...
     *     {@link com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)} to mixin a signature
     *     you create that identifies the data currently at the given String that will invalidate the cache if that data
     *     changes. Alternatively, using {@link com.txt.video.common.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.txt.video.common.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     * {@link com.txt.video.common.glide.load.model.UriLoader}.
     */
     ...
     *     Alternatively, using {@link com.txt.video.common.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.txt.video.common.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     ...
     * @see com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)
     */
     ...
     * @see #load(Uri)
     * @see com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)
     * @see com.txt.video.common.glide.signature.MediaStoreSignature
     *
     * @deprecated Use {@link #loadFromMediaStore(Uri)},
     * {@link com.txt.video.common.glide.signature.MediaStoreSignature}, and
     * {@link com.txt.video.common.glide.DrawableRequestBuilder#signature(com.txt.video.common.glide.load.Key)} instead. Scheduled to be
     ...
     *
     * <p>
     *  Falls back to the registered {@link com.txt.video.common.glide.load.model.ModelLoaderFactory} registered for
     ...
     *     {@link com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)} to mix in some
     *     additional data identifying the current state of the Uri, preferably using
     *     {@link com.txt.video.common.glide.signature.MediaStoreSignature}. Alternatively consider avoiding the memory and
     *     disk caches entirely using
     *     {@link GenericRequestBuilder#diskCacheStrategy(com.txt.video.common.glide.load.engine.DiskCacheStrategy)}
     *     and {@link com.txt.video.common.glide.load.engine.DiskCacheStrategy#NONE} and/or
     *     {@link com.txt.video.common.glide.GenericRequestBuilder#skipMemoryCache(boolean)}.
     * </p>
     *
     * @see #from(Class)
     * @see #loadFromMediaStore(Uri, String, long, int)
    ...
    /**
     * Returns a request builder that uses the {@link com.txt.video.common.glide.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link com.txt.video.common.glide.load.model.stream.StreamFileLoader.Factory} and
     * {@link com.txt.video.common.glide.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link com.txt.video.common.glide.load.model.stream.StreamResourceLoader.Factory} and
     * {@link com.txt.video.common.glide.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     *     cached data. To get around this, consider using {@link com.txt.video.common.glide.load.engine.DiskCacheStrategy#NONE}
     *     via {@link GenericRequestBuilder#diskCacheStrategy(com.txt.video.common.glide.load.engine.DiskCacheStrategy)}
     *     during development, and re-enabling the default
     *     {@link com.txt.video.common.glide.load.engine.DiskCacheStrategy#RESULT} for release builds.
     * </p>
     *
     * @see #from(Class)
     * @see #load(Integer)
     * @see com.txt.video.common.glide.signature.ApplicationVersionSignature
     * @see com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)
     */
     ...
     * {@link com.txt.video.common.glide.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link com.txt.video.common.glide.load.data.HttpUrlFetcher} to load {@link URL} models.
     *
     * @see #from(Class)
     * @see #load(URL)
     *
     ...
     * {@link com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)} instead. Scheduled to be
     * removed in Glide 4.0.
    ...
    /**
     * Returns a request builder that uses {@link com.txt.video.common.glide.load.model.stream.StreamByteArrayLoader} to load
    ...
    /**
     * Returns a request builder that uses the {@link com.txt.video.common.glide.load.model.ModelLoaderFactory}s currently
     ...
     * {@link com.txt.video.common.glide.load.model.ModelLoaderFactory}s registered for the given model class for
     * {@link InputStream}s and {@link ParcelFileDescriptor}s to load a thumbnail from objects of
     * the given modelClass.
     *
     * <p>
     *     Note - you must use {@link com.txt.video.common.glide.DrawableRequestBuilder#load(Object)}} to set a concrete model
     *     to be loaded before calling
     *     {@link com.txt.video.common.glide.DrawableRequestBuilder#into(com.txt.video.common.glide.request.target.Target)}. You may
     *     also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     *     also adjust the options after calling {@link com.txt.video.common.glide.DrawableRequestBuilder#load(Object)}} and/or
     *     {@link com.txt.video.common.glide.DrawableRequestBuilder#into(com.txt.video.common.glide.request.target.Target)}}. However,
    ...
    public final class ImageModelRequest<T> {
        ...
        /**
         * Returns a request builder that uses the provided {@link com.txt.video.common.glide.load.model.ModelLoader} to load
     ...
     * @param <T> The type of data the {@link com.txt.video.common.glide.load.model.ModelLoader} provides an
     * {@link com.txt.video.common.glide.load.data.DataFetcher} to convert the model to.
     */
    public final class GenericModelRequest<A, T> {
        ...
        /**
         * A helper class for building requests with custom {@link com.txt.video.common.glide.load.model.ModelLoader}s that
