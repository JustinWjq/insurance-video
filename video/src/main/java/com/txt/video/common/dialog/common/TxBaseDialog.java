package com.txt.video.common.dialog.common;
...
import com.txt.video.common.action.ClickAction;
import com.txt.video.common.action.HandlerAction;
import com.txt.video.common.action.KeyboardAction;
import com.txt.video.common.action.ResourcesAction;
...
//    private final LifecycleRegistry mLifecycle = new LifecycleRegistry(this);
    ...
    public TxBaseDialog(Context context) {
    ...
    public int getWindowAnimations() {
        ...
        return TxBaseDialog.ANIM_DEFAULT;
    }
...
//    }
    ...
    public void setOnKeyListener(@Nullable TxBaseDialog.OnKeyListener listener) {
...
//        mLifecycle.handleLifecycleEvent(Lifecycle.Event.ON_STOP);
    ...
    public static class Builder<B extends Builder> implements
         ...
         * 设置创建监听
         */
        public B setOnCreateListener(@NonNull TxBaseDialog.OnCreateListener listener) {
         ...
         * 添加显示监听
         */
        public B addOnShowListener(@NonNull TxBaseDialog.OnShowListener listener) {
            mShowListeners.add(listener);
            return (B) this;
        }
         ...
         * 添加取消监听
         */
        public B addOnCancelListener(@NonNull TxBaseDialog.OnCancelListener listener) {
            mCancelListeners.add(listener);
            return (B) this;
        }
         ...
         * 添加销毁监听
         */
        public B addOnDismissListener(@NonNull TxBaseDialog.OnDismissListener listener) {
            mDismissListeners.add(listener);
            return (B) this;
        }
         ...
         * 设置按键监听
         */
        public B setOnKeyListener(@NonNull TxBaseDialog.OnKeyListener listener) {
         ...
         * 设置点击事件
         */
        public B setOnClickListener(@IdRes int id, @NonNull TxBaseDialog.OnClickListener listener) {
            if (mClickArray == null) {
        ...
        public TxBaseDialog create() {
            ...
            if (mAnimStyle == TxBaseDialog.ANIM_DEFAULT) {
                switch (mGravity) {
                    case Gravity.TOP:
                        mAnimStyle = TxBaseDialog.ANIM_TOP;
                        break;
                    case Gravity.BOTTOM:
                        mAnimStyle = TxBaseDialog.ANIM_BOTTOM;
                        break;
                    case Gravity.LEFT:
                        mAnimStyle = TxBaseDialog.ANIM_LEFT;
                        break;
                    case Gravity.RIGHT:
                        mAnimStyle = TxBaseDialog.ANIM_RIGHT;
                        break;
                    default:
                        mAnimStyle = TxBaseDialog.ANIM_DEFAULT;
                        break;
                }
            }
         ...
         */
        @NonNull
        protected TxBaseDialog createDialog(Context context, @StyleRes int themeId) {
            return new TxBaseDialog(context, themeId);
        }
    ...
    private static final class DialogLifecycle implements
        ...
        private static void with(Activity activity, TxBaseDialog dialog) {
        ...
        public void onActivityPaused(@NonNull Activity activity) {
            ...
            if (mDialog != null && mDialog.isShowing()) {
                ...
                // 设置 Dialog 无动画效果
                mDialog.setWindowAnimations(TxBaseDialog.ANIM_EMPTY);
            }
        }
...
//            }
    ...
    private static final class ViewClickWrapper
        ...
        private final TxBaseDialog mDialog;
        private final OnClickListener mListener;

        private ViewClickWrapper(TxBaseDialog dialog, OnClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
    ...
    private static final class CancelListenerWrapper
        ...
        @Override
        public void onCancel(TxBaseDialog dialog) {
            // 在横竖屏切换后监听对象会为空
            if (get() != null) {
                get().onCancel(dialog);
            }
    ...
    private static final class KeyListenerWrapper
        ...
        public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null && dialog instanceof TxBaseDialog) {
                return mListener.onKey((TxBaseDialog) dialog, event);
            }
            return false;
        }
    }
    ...
    public interface OnClickListener<V extends View> {
        void onClick(TxBaseDialog dialog, V view);
    }
    ...
    public interface OnCreateListener {
         ...
         * Dialog 创建了
         */
        void onCreate(TxBaseDialog dialog);
    }
    ...
    public interface OnShowListener {
         ...
         * Dialog 显示了
         */
        void onShow(TxBaseDialog dialog);
    }
    ...
    public interface OnCancelListener {
         ...
         * Dialog 取消了
         */
        void onCancel(TxBaseDialog dialog);
    }
    ...
    public interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        void onDismiss(TxBaseDialog dialog);
    }
    ...
    public interface OnKeyListener {
         ...
         * 触发了按键
         */
        boolean onKey(TxBaseDialog dialog, KeyEvent event);
    }
}