...
/**
 * A wrapper resource that allows reference counting a wrapped {@link com.txt.video.common.glide.load.engine.Resource}
 * interface.
 *
...
class EngineResource<Z> implements Resource<Z> {
    ...
    interface ResourceListener {
        void onResourceReleased(Key key, com.txt.video.common.glide.load.engine.EngineResource<?> resource);
    }
