...
import com.txt.video.common.glide.request.target.BaseTarget;
import com.txt.video.common.glide.request.target.SizeReadyCallback;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a non null {@link com.txt.video.common.glide.GenericRequestBuilder} for a given item. Must exactly match
    ...
    /**
     * Constructor for {@link com.txt.video.common.glide.ListPreloader} that requires users to subclass and override
     * the {@link #getItems(int, int)} and {@link #getRequestBuilder(Object)} methods.
     *
     * @deprecated Use {@link #ListPreloader(com.txt.video.common.glide.ListPreloader.PreloadModelProvider,
     * com.txt.video.common.glide.ListPreloader.PreloadSizeProvider, int)} instead. This constructor will be removed in Glide
     * 4.0.
    ...
    /**
     * Constructor for {@link com.txt.video.common.glide.ListPreloader} that accepts interfaces for providing the dimensions of
     ...
     * </p>
     *
     * @deprecated Use {@link com.txt.video.common.glide.ListPreloader.PreloadSizeProvider} instead. This method will be removed
     * in Glide 4.0.
     * @param item A model
     ...
     * </p>
     *
     * @deprecated Use {@link com.txt.video.common.glide.ListPreloader.PreloadModelProvider} instead. This method will be
    ...
    /**
     * Returns a non null {@link com.txt.video.common.glide.GenericRequestBuilder} for a given item. Must exactly match the
