package com.txt.video.common.glide.request.animation;

/**
 * A simple {@link com.txt.video.common.glide.request.animation.GlideAnimation} that performs no actions.
 *
 * @param <R> animated resource type
 */
public class NoAnimation<R> implements GlideAnimation<R> {
    private static final com.txt.video.common.glide.request.animation.NoAnimation<?> NO_ANIMATION = new com.txt.video.common.glide.request.animation.NoAnimation<Object>();
    @SuppressWarnings("rawtypes")
    private static final GlideAnimationFactory<?> NO_ANIMATION_FACTORY = new NoAnimationFactory();

    /**
     * A factory that always returns the same {@link com.txt.video.common.glide.request.animation.NoAnimation}.
     */
    ...
    /**
     * Returns an instance of a factory that produces {@link com.txt.video.common.glide.request.animation.NoAnimation}s.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns an instance of {@link com.txt.video.common.glide.request.animation.NoAnimation}.
     */
    @SuppressWarnings("unchecked")
