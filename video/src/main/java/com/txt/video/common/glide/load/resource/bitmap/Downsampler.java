...
import com.txt.video.common.glide.util.ByteArrayPool;
import com.txt.video.common.glide.util.ExceptionCatchingInputStream;
import com.txt.video.common.glide.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
     ...
     */
    public static final com.txt.video.common.glide.load.resource.bitmap.Downsampler AT_LEAST = new com.txt.video.common.glide.load.resource.bitmap.Downsampler() {
        @Override
     ...
     */
    public static final com.txt.video.common.glide.load.resource.bitmap.Downsampler AT_MOST = new com.txt.video.common.glide.load.resource.bitmap.Downsampler() {
        @Override
        protected int getSampleSize(int inWidth, int inHeight, int outWidth, int outHeight) {
     ...
     */
    public static final com.txt.video.common.glide.load.resource.bitmap.Downsampler NONE = new com.txt.video.common.glide.load.resource.bitmap.Downsampler() {
        @Override
        protected int getSampleSize(int inWidth, int inHeight, int outWidth, int outHeight) {
            return 0;
        }
