...
/**
 * A {@link com.txt.video.common.glide.request.animation.GlideAnimation GlideAnimation} that accepts an interface
...
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
     ...
     * {@link com.txt.video.common.glide.request.animation.ViewPropertyAnimation.Animator} interface that can apply an animation
     * to a view.
     *
    ...
    /**
     * Always applies the {@link com.txt.video.common.glide.request.animation.ViewPropertyAnimation.Animator} given in the
