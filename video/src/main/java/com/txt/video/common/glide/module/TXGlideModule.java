package com.txt.video.common.glide.module;

import android.content.Context;

import com.txt.video.common.glide.TxGlide;
import com.txt.video.common.glide.GlideBuilder;

/**
 * An interface allowing lazy configuration of Glide including setting options using
 * {@link com.txt.video.common.glide.GlideBuilder} and registering
 * {@link com.txt.video.common.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p>
 ...
 *             {@link TxGlide#register(Class, Class, com.txt.video.common.glide.load.model.ModelLoaderFactory)}
 *             for each {@link com.txt.video.common.glide.load.model.ModelLoader} you'd like to register:
 *             <pre>
 *                  <code>
...
public interface TXGlideModule {
    ...
    /**
     * Lazily apply options to a {@link com.txt.video.common.glide.GlideBuilder} immediately before the Glide singleton is
     * created.
     *
     * <p>
     ...
     * @param builder The {@link com.txt.video.common.glide.GlideBuilder} that will be used to create Glide.
     */
