...
import com.txt.video.common.glide.load.data.ByteArrayFetcher;
...
public class StreamByteArrayLoader implements StreamModelLoader<byte[]> {
    ...
    /**
     * @deprecated Use {@link com.txt.video.common.glide.GenericRequestBuilder#signature(com.txt.video.common.glide.load.Key)}
    ...
    /**
     * Factory for {@link com.txt.video.common.glide.load.model.stream.StreamByteArrayLoader}.
     */
    public static class Factory implements ModelLoaderFactory<byte[], InputStream> {
        ...
        public ModelLoader<byte[], InputStream> build(Context context, GenericLoaderFactory factories) {
            return new com.txt.video.common.glide.load.model.stream.StreamByteArrayLoader();
        }
