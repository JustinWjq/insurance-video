 ...
 * @param <Y> The type of the data that can be used by a {@link com.txt.video.common.glide.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@link com.txt.video.common.glide.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
     ...
     * cached, or null if no valid {@link com.txt.video.common.glide.load.data.DataFetcher} could be constructed.
     */
