...
/**
 * Creates an {@link com.txt.video.common.glide.disklrucache.DiskLruCache} based disk cache in the specified disk cache
 * directory.
 * <p/>
 * If you need to make I/O access before returning the cache directory use
 * the {@link com.txt.video.common.glide.load.engine.cache.DiskLruCacheFactory#DiskLruCacheFactory(CacheDirectoryGetter, int)} constructor variant.
 */
