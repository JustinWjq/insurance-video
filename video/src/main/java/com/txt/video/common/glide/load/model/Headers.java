...
public interface Headers {
     ...
     */
    @Deprecated
    com.txt.video.common.glide.load.model.Headers NONE = new com.txt.video.common.glide.load.model.Headers() {
        @Override
     ...
     */
    com.txt.video.common.glide.load.model.Headers DEFAULT = new LazyHeaders.Builder().build();
