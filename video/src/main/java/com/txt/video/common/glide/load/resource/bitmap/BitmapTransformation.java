...
/**
 * A simple {@link com.txt.video.common.glide.load.Transformation} for transforming {@link Bitmap}s that
 * abstracts away dealing with {@link com.txt.video.common.glide.load.engine.Resource} objects for subclasses.
 *
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
     ...
     *
     * <p>
     *     outWidth and outHeight will never be {@link com.txt.video.common.glide.request.target.Target#SIZE_ORIGINAL}, this
     *     class converts them to be the size of the Bitmap we're going to transform before calling this method.
     * </p>
     *
     * @param pool A {@link com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool} that can be used to obtain and
