...
public final class ByteArrayPool {
    ...
    private static final com.txt.video.common.glide.util.ByteArrayPool BYTE_ARRAY_POOL = new com.txt.video.common.glide.util.ByteArrayPool();

    /**
     * Returns a constant singleton byte array pool.
     */
    public static com.txt.video.common.glide.util.ByteArrayPool get() {
