...
/**
 * An {@link com.txt.video.common.glide.load.Transformation} that wraps a transformation for a {@link Bitmap}
 * and can apply it to every frame of any {@link com.txt.video.common.glide.load.resource.gif.GifDrawable}.
 */
