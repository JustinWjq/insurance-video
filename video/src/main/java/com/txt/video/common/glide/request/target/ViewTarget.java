...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
    ...
    public static void setTagId(int tagId) {
        if (com.txt.video.common.glide.request.target.ViewTarget.tagId != null || isTagUsedAtLeastOnce) {
        ...
        com.txt.video.common.glide.request.target.ViewTarget.tagId = tagId;
    }
     ...
     *     that is not an {@link com.txt.video.common.glide.request.Request}.
     * </p>
     */
    @Override
    ...
    private static class SizeDeterminer {
        ...
        private static class SizeDeterminerLayoutListener implements ViewTreeObserver.OnPreDrawListener {
            ...
            public SizeDeterminerLayoutListener(com.txt.video.common.glide.request.target.ViewTarget.SizeDeterminer sizeDeterminer) {
            ...
            public boolean onPreDraw() {
                ...
                com.txt.video.common.glide.request.target.ViewTarget.SizeDeterminer sizeDeterminer = sizeDeterminerRef.get();
