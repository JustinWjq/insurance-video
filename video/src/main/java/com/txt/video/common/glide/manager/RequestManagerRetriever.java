...
/**
 * A collection of static methods for creating new {@link com.txt.video.common.glide.RequestManager}s or retrieving existing
...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private static final com.txt.video.common.glide.manager.RequestManagerRetriever INSTANCE = new com.txt.video.common.glide.manager.RequestManagerRetriever();
     ...
     */
    public static com.txt.video.common.glide.manager.RequestManagerRetriever get() {
        return INSTANCE;
    }
            ...
            synchronized (this) {
                if (applicationManager == null) {
                    ...
                    applicationManager = new RequestManager(context.getApplicationContext(),
                            new ApplicationLifecycle(), new com.txt.video.common.glide.manager.EmptyRequestManagerTreeNode());
                }
            }
        }
