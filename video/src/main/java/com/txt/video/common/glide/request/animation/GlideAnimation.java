 ...
 * {@link com.txt.video.common.glide.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * ({@link com.txt.video.common.glide.request.animation.ViewAnimation},
     * {@link com.txt.video.common.glide.request.animation.ViewPropertyAnimation} and animated
     * {@link Drawable}s).
     */
     ...
     * @param adapter The {@link com.txt.video.common.glide.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link View} from
     *                {@link com.txt.video.common.glide.request.animation.GlideAnimation.ViewAdapter#getView()}.
