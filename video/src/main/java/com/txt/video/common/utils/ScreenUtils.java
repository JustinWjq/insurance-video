...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) TXSdk.getInstance().application.getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) return -1;
    ...
    public static boolean isLandscape() {
        return TXSdk.getInstance().application.getResources().getConfiguration().orientation
...
//    }
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager)  TXSdk.getInstance().application.getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                TXSdk.getInstance().application.getContentResolver(),
