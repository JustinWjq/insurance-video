...
/**
 * A view-less {@link Fragment} used to safely store an {@link com.txt.video.common.glide.RequestManager} that
 * can be used to start, stop and manage Glide requests started for targets the fragment or activity this fragment is a
 * child of.
 *
 * @see com.txt.video.common.glide.manager.SupportRequestManagerFragment
 * @see com.txt.video.common.glide.manager.RequestManagerRetriever
 * @see com.txt.video.common.glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
    ...
    private final com.txt.video.common.glide.manager.ActivityFragmentLifecycle lifecycle;
    ...
    private com.txt.video.common.glide.manager.RequestManagerFragment rootRequestManagerFragment;

    public RequestManagerFragment() {
        this(new com.txt.video.common.glide.manager.ActivityFragmentLifecycle());
    }

    // For testing only.
    @SuppressLint("ValidFragment")
    RequestManagerFragment(com.txt.video.common.glide.manager.ActivityFragmentLifecycle lifecycle) {
        this.lifecycle = lifecycle;
    }

    /**
     * Sets the current {@link com.txt.video.common.glide.RequestManager}.
     *
    ...
    /**
     * Returns the current {@link com.txt.video.common.glide.RequestManager} or null if none exists.
     */
    ...
    private void addChildRequestManagerFragment(com.txt.video.common.glide.manager.RequestManagerFragment child) {
        childRequestManagerFragments.add(child);
    }

    private void removeChildRequestManagerFragment(com.txt.video.common.glide.manager.RequestManagerFragment child) {
    ...
    public Set<RequestManagerFragment> getDescendantRequestManagerFragments() {
        if (rootRequestManagerFragment == this) {
            ...
            for (com.txt.video.common.glide.manager.RequestManagerFragment fragment
    ...
    private class FragmentRequestManagerTreeNode implements RequestManagerTreeNode {
        ...
        public Set<RequestManager> getDescendants() {
            ...
            for (com.txt.video.common.glide.manager.RequestManagerFragment fragment : descendantFragments) {
