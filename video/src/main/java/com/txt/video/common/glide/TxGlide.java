...
import com.txt.video.common.glide.load.engine.Engine;
import com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool;
import com.txt.video.common.glide.load.engine.cache.DiskLruCacheFactory;
import com.txt.video.common.glide.load.engine.cache.MemoryCache;
import com.txt.video.common.glide.load.engine.prefill.BitmapPreFiller;
import com.txt.video.common.glide.load.engine.prefill.PreFillType;
...
import com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import com.txt.video.common.glide.load.model.stream.HttpUrlGlideUrlLoader;
import com.txt.video.common.glide.load.model.stream.StreamByteArrayLoader;
import com.txt.video.common.glide.load.model.stream.StreamFileLoader;
import com.txt.video.common.glide.load.model.stream.StreamResourceLoader;
import com.txt.video.common.glide.load.model.stream.StreamStringLoader;
import com.txt.video.common.glide.load.model.stream.StreamUriLoader;
import com.txt.video.common.glide.load.model.stream.StreamUrlLoader;
import com.txt.video.common.glide.load.resource.bitmap.CenterCrop;
import com.txt.video.common.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.txt.video.common.glide.load.resource.bitmap.FitCenter;
import com.txt.video.common.glide.load.resource.bitmap.GlideBitmapDrawable;
import com.txt.video.common.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.txt.video.common.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.txt.video.common.glide.load.resource.drawable.GlideDrawable;
import com.txt.video.common.glide.load.resource.file.StreamFileDataLoadProvider;
import com.txt.video.common.glide.load.resource.gif.GifDrawable;
import com.txt.video.common.glide.load.resource.gif.GifDrawableLoadProvider;
...
import com.txt.video.common.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.txt.video.common.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.txt.video.common.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.txt.video.common.glide.load.resource.transcode.ResourceTranscoder;
import com.txt.video.common.glide.load.resource.transcode.TranscoderRegistry;
import com.txt.video.common.glide.manager.RequestManagerRetriever;
import com.txt.video.common.glide.module.ManifestParser;
import com.txt.video.common.glide.module.TXGlideModule;
import com.txt.video.common.glide.provider.DataLoadProvider;
import com.txt.video.common.glide.provider.DataLoadProviderRegistry;
import com.txt.video.common.glide.request.FutureTarget;
import com.txt.video.common.glide.request.Request;
import com.txt.video.common.glide.request.animation.GlideAnimation;
import com.txt.video.common.glide.request.target.ImageViewTargetFactory;
import com.txt.video.common.glide.request.target.Target;
import com.txt.video.common.glide.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@link com.txt.video.common.glide.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class TxGlide {
    ...
    /**
     * Returns the {@link com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool} used to temporarily store
     ...
     *     {@link com.txt.video.common.glide.load.ResourceDecoder}s and {@link com.txt.video.common.glide.load.Transformation}s. Use
    ...
    /**
     * Pre-fills the {@link com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool} using the given sizes.
     *
     * <p>
     ...
     *     re-filling the {@link com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
     ...
     *     {@link com.txt.video.common.glide.load.engine.prefill.PreFillType.Builder Builders} representing
     ...
     * models. Typically the {@link RequestManager#using(com.txt.video.common.glide.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * </p>
     *
     * @see RequestManager#using(com.txt.video.common.glide.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(com.txt.video.common.glide.load.model.stream.StreamModelLoader)
     *
     ...
     *
     * @deprecated Use {@link #register(Class, Class, com.txt.video.common.glide.load.model.ModelLoaderFactory)} to replace
