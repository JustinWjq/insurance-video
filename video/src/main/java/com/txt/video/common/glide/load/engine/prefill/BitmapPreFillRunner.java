...
import com.txt.video.common.glide.load.resource.bitmap.BitmapResource;
 ...
 * {@link com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool} is pre-populated.
 *
...
final class BitmapPreFillRunner implements Runnable {
    ...
    private final com.txt.video.common.glide.load.engine.prefill.PreFillQueue toPrefill;
    ...
    public BitmapPreFillRunner(BitmapPool bitmapPool, MemoryCache memoryCache, com.txt.video.common.glide.load.engine.prefill.PreFillQueue allocationOrder) {
        this(bitmapPool, memoryCache, allocationOrder, DEFAULT_CLOCK, new Handler(Looper.getMainLooper()));
    }

    // Visible for testing.
    BitmapPreFillRunner(BitmapPool bitmapPool, MemoryCache memoryCache, com.txt.video.common.glide.load.engine.prefill.PreFillQueue allocationOrder, Clock clock,
                        Handler handler) {
