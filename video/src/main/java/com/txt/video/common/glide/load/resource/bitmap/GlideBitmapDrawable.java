...
/**
 * A static {@link com.txt.video.common.glide.load.resource.drawable.GlideDrawable} for displaying a single image.
 */
public class GlideBitmapDrawable extends GlideDrawable {
    ...
    static class BitmapState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            return new com.txt.video.common.glide.load.resource.bitmap.GlideBitmapDrawable(null, this);
        }

        @Override
        public Drawable newDrawable(Resources res) {
            return new com.txt.video.common.glide.load.resource.bitmap.GlideBitmapDrawable(res, this);
        }
