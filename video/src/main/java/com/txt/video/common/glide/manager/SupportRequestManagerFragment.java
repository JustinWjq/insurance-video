 ...
 * {@link com.txt.video.common.glide.RequestManager} that can be used to start, stop and manage Glide requests started for
 * targets within the fragment or activity this fragment is a child of.
 *
 * @see com.txt.video.common.glide.manager.RequestManagerFragment
...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private com.txt.video.common.glide.manager.SupportRequestManagerFragment rootRequestManagerFragment;
    ...
    /**
     * Returns the current {@link com.txt.video.common.glide.RequestManager} or null if none is set.
     */
    ...
    private void addChildRequestManagerFragment(com.txt.video.common.glide.manager.SupportRequestManagerFragment child) {
        childRequestManagerFragments.add(child);
    }

    private void removeChildRequestManagerFragment(com.txt.video.common.glide.manager.SupportRequestManagerFragment child) {
    ...
    public Set<SupportRequestManagerFragment> getDescendantRequestManagerFragments() {
        if (rootRequestManagerFragment == null) {
            ...
            HashSet<SupportRequestManagerFragment> descendants =
                new HashSet<SupportRequestManagerFragment>();
            for (com.txt.video.common.glide.manager.SupportRequestManagerFragment fragment
    ...
    private class SupportFragmentRequestManagerTreeNode implements RequestManagerTreeNode {
        ...
        public Set<RequestManager> getDescendants() {
            ...
            for (com.txt.video.common.glide.manager.SupportRequestManagerFragment fragment : descendantFragments) {
