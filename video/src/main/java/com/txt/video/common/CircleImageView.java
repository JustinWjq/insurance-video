...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.tx_CircleImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.tx_CircleImageView_tx_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.tx_CircleImageView_tx_civ_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.tx_CircleImageView_tx_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.tx_CircleImageView_tx_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
