...
class EngineKey implements Key {
    ...
    public Key getOriginalKey() {
        if (originalKey == null) {
            originalKey = new com.txt.video.common.glide.load.engine.OriginalKey(id, signature);
        }
        return originalKey;
    }
    ...
    public boolean equals(Object o) {
        ...
        com.txt.video.common.glide.load.engine.EngineKey engineKey = (com.txt.video.common.glide.load.engine.EngineKey) o;
