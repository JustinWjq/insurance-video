...
import com.txt.video.common.glide.load.engine.executor.Prioritized;
import com.txt.video.common.glide.request.ResourceCallback;

/**
 * A runnable class responsible for using an {@link com.txt.video.common.glide.load.engine.DecodeJob} to decode resources on a
 ...
 *     {@link com.txt.video.common.glide.load.engine.DecodeJob} to decode data directly from the original source.
 * </p>
 *
 * <p>
...
class EngineRunnable implements Runnable, Prioritized {
    ...
    private final com.txt.video.common.glide.load.engine.DecodeJob<?, ?, ?> decodeJob;

    private Stage stage;

    private volatile boolean isCancelled;

    public EngineRunnable(EngineRunnableManager manager, com.txt.video.common.glide.load.engine.DecodeJob<?, ?, ?> decodeJob, Priority priority) {
    ...
    interface EngineRunnableManager extends ResourceCallback {
        void submitForSource(com.txt.video.common.glide.load.engine.EngineRunnable runnable);
    }
}
