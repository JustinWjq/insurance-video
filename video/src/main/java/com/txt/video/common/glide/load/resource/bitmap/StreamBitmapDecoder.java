...
/**
 * An {@link com.txt.video.common.glide.load.ResourceDecoder} that uses an
 * {@link com.txt.video.common.glide.load.resource.bitmap.Downsampler} to decode an {@link Bitmap} from an
 * {@link InputStream}.
 */
