package com.txt.video.common.glide.load.data;
 ...
 * resource load by {@link com.txt.video.common.glide.load.model.ModelLoader}. {@link #loadData(Priority)} may or may not be
...
public interface DataFetcher<T> {
     ...
     * {@link com.txt.video.common.glide.load.ResourceDecoder}.
     *
     * <p>
     *     Note - this method will be run on a background thread so blocking I/O is safe.
     * </p>
