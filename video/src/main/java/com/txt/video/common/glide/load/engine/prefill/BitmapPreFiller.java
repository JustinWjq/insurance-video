 ...
 * {@link com.txt.video.common.glide.load.engine.bitmap_recycle.BitmapPool}.
 */
public final class BitmapPreFiller {
    ...
    public void preFill(PreFillType.Builder... bitmapAttributeBuilders) {
        ...
        com.txt.video.common.glide.load.engine.prefill.PreFillQueue allocationOrder = generateAllocationOrder(bitmapAttributes);
        current = new BitmapPreFillRunner(bitmapPool, memoryCache, allocationOrder);
        handler.post(current);
    }

    // Visible for testing.
    com.txt.video.common.glide.load.engine.prefill.PreFillQueue generateAllocationOrder(PreFillType[] preFillSizes) {
        ...
        return new com.txt.video.common.glide.load.engine.prefill.PreFillQueue(attributeToCount);
    }
