...
import com.txt.video.common.glide.GenericRequestBuilder;
...
import com.txt.video.common.glide.request.target.SimpleTarget;
    ...
    private class FrameLoaderCallback implements Handler.Callback {
        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == MSG_DELAY) {
                com.txt.video.common.glide.load.resource.gif.GifFrameLoader.DelayTarget target = (DelayTarget) msg.obj;
                onFrameReady(target);
                return true;
