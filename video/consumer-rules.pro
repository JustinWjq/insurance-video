...
-keep public class * implements com.txt.video.common.glide.module.GlideModule
-keep public enum com.txt.video.common.glide.load.resource.bitmap.ImageHeaderParser$** {
  **[] $VALUES;
  public *;
}

-dontwarn com.txt.video.widget.glide.**
-keep class com.txt.video.common.glide.**{*;}
-keep class com.txt.video.common.glide.gifdecoder.**{*;}


-keep public class com.txt.video.common.glide.load.resource.gif.GifDrawable{*;}
-keep  class com.txt.video.common.glide.load.resource.gif.GifDrawable$GifState{
        <methods>;
        <fields>;
}
-keep  class com.txt.video.common.glide.load.resource.gif.GifFrameLoader{*;}
-keep  class com.txt.video.common.glide.gifdecoder.GifDecoder{*;}
